 ...
 *
 * <ul>
 *   <li><b>Shot Logged Interlock:</b> Prevents shooting until previous shot is logged (Hit/Miss
 *       clicked)
 *   <li><b>Coefficients Updated Interlock:</b> Prevents shooting until tuner updates coefficients
 * </ul>
 *
 * <p>Both interlocks default to DISABLED for normal operation. Enable them in tuner_config.ini for
 * maximum data quality during tuning sessions.
 *
 * <p><b>Usage:</b>
 *
 * <pre>
...
public class ShooterInterlock {
   ...
   *
   * <ul>
   *   <li>/FiringSolver/Interlock/RequireShotLogged - Enable/disable shot logging interlock
   *   <li>/FiringSolver/Interlock/RequireCoefficientsUpdated - Enable/disable coefficient interlock
   *   <li>/FiringSolver/Interlock/ShotLogged - Set true when driver logs hit/miss
   *   <li>/FiringSolver/Interlock/CoefficientsUpdated - Set true when tuner updates coefficients
   *   <li>/FiringSolver/Interlock/CanShoot - Output: true if robot is allowed to shoot
   * </ul>
   */
  public ShooterInterlock() {
    ...
    requireCoefficientsUpdatedEntry =
        table.getBooleanTopic("RequireCoefficientsUpdated").getEntry(false);
   ...
   *
   * <ul>
   *   <li>Driver to log hit/miss (if that interlock is enabled)
   *   <li>Tuner to update coefficients (if that interlock is enabled)
   * </ul>
   */
